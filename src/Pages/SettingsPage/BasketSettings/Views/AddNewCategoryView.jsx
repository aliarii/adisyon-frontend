...
import { createBasketCategory } from '../../../../State/BasketCategory/Action';
import { getCompanyById } from '../../../../State/Company/Action';
import { useTranslation } from 'react-i18next';

const AddNewCategoryView = ({ baskets, handleCancel }) => {
    const { company } = useSelector((store) => store.company)
    const dispatch = useDispatch();
    const [categoryName, setCategoryName] = useState('');
    const [notSelectedBaskets, setNotSelectedBaskets] = useState(baskets);
    ...
    const handleCategorySave = () => {
        ...
        dispatch(createBasketCategory(reqData))
